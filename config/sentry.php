 ...
 *
 * Error tracking stays disabled unless SENTRY_LARAVEL_DSN is set. GlitchTip is
 * Sentry-protocol compatible: point the DSN at a GlitchTip project to use it
 * instead (docs/adr/0029-error-tracking-integration.md, open question #13).
 *
...
return [
    ...
    // Hard-coded off: PII must never reach the error tracker (plan 19.2, 24.2).
    'send_default_pii' => false,

    // Scrubs secrets and PII with the same redactor used by the log channels.
