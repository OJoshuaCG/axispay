...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Spanish (neutral, formal "usted" register) validator messages. Keys mirror
    | lang/en/validation.php exactly; keep both files in sync when Laravel adds
    | rules. :attribute is replaced by the entry in `attributes` below when one
    | exists, so add readable Spanish names there for every form field.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor de :attribute ha aparecido en una filtración de datos. Elija un valor diferente para :attribute.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Custom messages for attributes, using the "attribute.rule" convention.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Readable Spanish names for form fields, e.g. 'email' => 'correo electrónico'.
    |
    */
